//
//  EatenVSBurnedCalGraphDay.swift
//  ZakFitFront
//
...
struct EatenVSBurnedCalGraphDay: View {
    ...
    var body: some View {
        ...
        let APNeeded = userAPVM.APs.filter { $0.date.isInSameDay(as: selectedDay) }
        let CalNeeded = userMealVM.mealList.filter { $0.date.isInSameDay(as: selectedDay) }
